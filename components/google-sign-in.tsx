    ...
    <Card className="w-full max-w-md mx-auto">
      <CardContent className="p-6">
        <div className="text-center mb-6">
          ...
          <p className="text-muted-foreground">Connectez-vous avec votre compte Google pour accéder aux quiz</p>
        </div>

<Button onClick={handleSignIn} className="w-full bg-transparent" variant="outline" size="lg">
  <svg 
    className="w-5 h-5 mr-2 transition-transform duration-200 hover:scale-110" 
    viewBox="0 0 24 24"
  >
